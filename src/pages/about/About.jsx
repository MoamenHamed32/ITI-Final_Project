            ...
            <div className="grid md:grid-cols-2 sm:grid-cols-1 gap-8">
              <div className="">
                <div className="about-photo ">
                  <img src={about} alt="" className={`${styles.about_img} object-cover w-full h-full rounded-md`}/>
                </div>
              </div>
              <div className={styles.about_brief_container}>
                <div className={`${styles.about_brief} bg-gray-50 p-6 md:p-8 lg:p-10 rounded-md overflow-auto`}>
